...
<c:url
	var="postEditForm"
	value="<%=WebConstant.URL_POST_EDIT%>">
		...
		<div
			...
			<nav
				...
				<div
					...
					style="padding-right: .75rem; padding-left: .75rem; color: #4e73df; font-weight: 600 !important; margin: 0 auto; font-size: xx-large; /* align-content: center;">${title_post_edit}</div>
			</nav>
